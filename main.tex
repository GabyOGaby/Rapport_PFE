...
\midrule
Zero-shot & Gelé & 58%$ (+- 1%$)$\
Transfer learning & Gelé &  64%$ (+- 2%$)\
Fine-tuning & Non gelé &  66%$ (+- 2%$) \
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=\textwidth]{figures/gradcam_2d_stress.png}
...
\begin{figure}[htbp]
    \centering
    % Insérer ici la figure Grad-CAM++
    \includegraphics[width=\textwidth]{figures/gradcam_2d_control.png}
