...
La RMN repose sur l'interaction entre le moment magnétique (spin) de certains noyaux atomiques et des champs magnétiques externes. Placés dans un tel champ, les noyaux s'ordonnent partiellement, faisant apparaître une aimantation macroscopique au sein de l'échantillon. Une brève impulsion radiofréquence (RF) appliquée à la fréquence de résonance du noyau vient perturber cet équilibre. Lors de la phase de relaxation qui suit l'arrêt de l'impulsion, les spins reviennent à leur état d'équilibre en émettant un signal RF détectable. L'analyse de cette relaxation — notamment le temps de relaxation transversal $T_2$ — fournit des informations sur la dynamique de l'eau.
...
(1) Notre jeu de données présente trois dimensions d’évolution. La première est une dimension spatiale, correspondant à la profondeur au sein de l’échantillon. La deuxième est une dimension temporelle à l’échelle de la milliseconde, correspondant au temps d’écho, selon lequel évolue chaque signal de RMN. Enfin, une troisième dimension temporelle, à une échelle macroscopique de l’ordre de l’heure, permet de suivre l’évolution des signaux au cours du temps et notamment au regard du cycle circadien.

(2) On observe un signal très localisé, à une profondeur correspondant à celle de la racine. Elle est la seule composante qui comporte une grande quantité d'eau dans notre système expérimental/
(3) Voici un signal de décroissance type qui est généralement multiexponentiel. Il s'agit ici d'une moyenne des signaux mesurés sur le rumex.
...
\end{table}
L'analyse des résultats montre que l'algorithme KNN se distingue des autres méthodes pour deux raisons déterminantes. D'une part, il est le plus rapide, ce qui le rend particulièrement adapté à un pipeline de prétraitement. D'autre part, il est le \textbf{seul} à avoir correctement identifié les profils aberrants préalablement repérés lors de l'analyse visuelle, notamment les \num{16} et \num{51} mesures corrompues des deux espèces cibles. En éliminant proprement ces observations avant la phase de classification, le KNN a supprimé d'importants vecteurs de confusion et permis au modèle 1D-CNN d'atteindre ses meilleures performances. Il a donc été systématiquement appliqué sur les données.
